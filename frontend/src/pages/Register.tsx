    ...
    <div className="min-h-[calc(100vh-80px)] flex flex-col items-center justify-center px-4 py-12 relative">
      ...
      <div className="w-full max-w-md mt-8">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-600 mt-2">Get started with sharing group expenses</p>
        </div>
        ...
        <div className="glass-panel p-8 rounded-3xl shadow-2xl relative overflow-hidden">
          ...
          <div className="mt-8 pt-6 border-t border-slate-200/60 text-center">
            ...
            <Link to="/login" className="text-brand-500 hover:text-brand-600 font-bold text-sm transition-colors">
              Log In
            </Link>
          </div>
        </div>
